/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLPointCloudStorageNode.cxx,v $
...
//----------------------------------------------------------------------------
vtkMRMLNodeNewMacro(vtkMRMLPointCloudStorageNode);

//----------------------------------------------------------------------------
vtkMRMLPointCloudStorageNode::vtkMRMLPointCloudStorageNode()
{
}
...
//----------------------------------------------------------------------------
void vtkMRMLPointCloudStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  vtkMRMLStorageNode::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
bool vtkMRMLPointCloudStorageNode::CanReadInReferenceNode(vtkMRMLNode *refNode)
{
  return refNode->IsA("vtkMRMLPointCloudNode");
}

//----------------------------------------------------------------------------
int vtkMRMLPointCloudStorageNode::ReadDataInternal(vtkMRMLNode *refNode)
{
  vtkMRMLPointCloudNode *modelNode = dynamic_cast <vtkMRMLPointCloudNode *> (refNode);
...
//----------------------------------------------------------------------------
int vtkMRMLPointCloudStorageNode::WriteDataInternal(vtkMRMLNode *refNode)
{
  vtkMRMLPointCloudNode *modelNode = vtkMRMLPointCloudNode::SafeDownCast(refNode);

  std::string fullName = this->GetFullNameFromFileName();
  if (fullName == std::string(""))
    {
    vtkErrorMacro("vtkMRMLPointCloudNode: File name not specified");
    return 0;
    }
...
//----------------------------------------------------------------------------
void vtkMRMLPointCloudStorageNode::InitializeSupportedReadFileTypes()
{
...
//----------------------------------------------------------------------------
void vtkMRMLPointCloudStorageNode::InitializeSupportedWriteFileTypes()
{
...
//----------------------------------------------------------------------------
const char* vtkMRMLPointCloudStorageNode::GetDefaultWriteFileExtension()
{
  return "vtk";
}
