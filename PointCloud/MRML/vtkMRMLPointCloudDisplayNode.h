/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLPointCloudDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkMRMLPointCloudDisplayNode_h
#define __vtkMRMLPointCloudDisplayNode_h
...
///
/// vtkMRMLPointCloudDisplayNode nodes stores display property of a 3D surface model
/// including reference to ColorNode, texture, opacity, etc.
class VTK_MRML_EXPORT vtkMRMLPointCloudDisplayNode : public vtkMRMLDisplayNode
{
public:
  static vtkMRMLPointCloudDisplayNode *New();
  vtkTypeMacro(vtkMRMLPointCloudDisplayNode,vtkMRMLDisplayNode);

  virtual vtkMRMLNode* CreateNodeInstance();

  /// Get node XML tag name (like Volume, PointCloud)
  virtual const char* GetNodeTagName() {return "PointCloudDisplay";};
...
protected:
  vtkMRMLPointCloudDisplayNode();
  ~vtkMRMLPointCloudDisplayNode();
  vtkMRMLPointCloudDisplayNode(const vtkMRMLPointCloudDisplayNode&);
  void operator=(const vtkMRMLPointCloudDisplayNode&);
