/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLPointCloudNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkMRMLPointCloudNode_h
#define __vtkMRMLPointCloudNode_h

// MRML includes
#include "vtkMRMLDisplayableNode.h"
class vtkMRMLPointCloudDisplayNode;
...
///
/// PointCloud nodes describe polygonal data.
/// When a model display node (vtkMRMLPointCloudDisplayNode) is observed by the
...
/// PointClouds are assumed to have been constructed with the orientation and voxel
/// dimensions of the original segmented volume.
class VTK_MRML_EXPORT vtkMRMLPointCloudNode : public vtkMRMLDisplayableNode
{
public:
  static vtkMRMLPointCloudNode *New();
  vtkTypeMacro(vtkMRMLPointCloudNode,vtkMRMLDisplayableNode);
  ...
  /// Get node XML tag name (like Volume, PointCloud)
  virtual const char* GetNodeTagName() {return "PointCloud";};
 ...
 /// Description:
  ...
  vtkMRMLPointCloudDisplayNode* GetPointCloudDisplayNode();
...
protected:
  vtkMRMLPointCloudNode();
  ~vtkMRMLPointCloudNode();
  vtkMRMLPointCloudNode(const vtkMRMLPointCloudNode&);
  void operator=(const vtkMRMLPointCloudNode&);
  ...
  virtual void SetPolyDataToDisplayNode(vtkMRMLPointCloudDisplayNode* modelDisplayNode);
